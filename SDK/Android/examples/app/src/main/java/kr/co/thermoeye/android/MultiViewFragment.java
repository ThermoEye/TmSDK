...
public class MultiViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        imageViews[4] = bindingCameraView.imageView5;
        imageViews[5] = bindingCameraView.imageView6;
        imageViews[6] = bindingCameraView.imageView7;
        imageViews[7] = bindingCameraView.imageView8;
        imageViews[8] = bindingCameraView.imageView9;
        ...
        cameraViewModel.getBitmapFrame(0).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[0].setPadding(1, 1, 1, 1);
                imageViews[0].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(1).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[1].setPadding(1, 1, 1, 1);
                imageViews[1].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(2).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[2].setPadding(1, 1, 1, 1);
                imageViews[2].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(3).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[3].setPadding(1, 1, 1, 1);
                imageViews[3].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(4).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[4].setPadding(1, 1, 1, 1);
                imageViews[4].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(5).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[5].setPadding(1, 1, 1, 1);
                imageViews[5].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(6).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[6].setPadding(1, 1, 1, 1);
                imageViews[6].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(7).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[7].setPadding(1, 1, 1, 1);
                imageViews[7].setImageBitmap(bitmap);
            }
        });
        cameraViewModel.getBitmapFrame(8).observe(getViewLifecycleOwner(), bitmap -> {
            if (bitmap != null) {
                imageViews[8].setPadding(1, 1, 1, 1);
                imageViews[8].setImageBitmap(bitmap);
            }
        });
