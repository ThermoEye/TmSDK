...
class SensorControl:
    ...
    def pushButton_RestoreDefaultFluxParameters_160E_Clicked(self):
        ...
        if success:
            ...
            self.main_window.doubleSpinBox_FluxParam160E_WindowReflection.setEnabled(True)
            self.main_window.doubleSpinBox_FluxParam160E_WindowReflectedTemperature.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_SceneEmissivityRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_BackgroundTemperatureRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_WindowTransmissionRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_WindowTemperatureRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_AtmosphericTransmissionRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_AtmosphericTemperatureRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_WindowReflectionRange.setEnabled(True)
            self.main_window.lineEdit_FluxParam160E_WindowReflectedTemperatureRange.setEnabled(True)
            self.main_window.pushButton_SetFluxParameters_160E.setEnabled(True)
