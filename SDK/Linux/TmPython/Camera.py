...
class Camera:
    ...
    def disconnect_camera(self):
        ...
        self.main_window.groupBox_2.setEnabled(False)
        self.main_window.groupBox_3.setEnabled(False)
        self.main_window.groupBox_10.setEnabled(False)
        ...
        if (self.main_window.pushButton_LocalCameraConnect.text() == "Connect"):
            try:
                ...
                if ret:
                    ...
                    self.main_window.groupBox_10.setEnabled(True)
                    self.main_window.groupBox_2.setEnabled(True)
                    self.main_window.groupBox_3.setEnabled(True)
