...
{
	/// <summary>
	/// Class providing control functionalities for the TmCtrl80 camera.
	/// </summary>
	class TmCtrl80 : public TmControl
	{
	public:
	...
	public:
		...
		bool CheckFirmware(std::string fwFilePath, std::string& vendorName, std::string& productName, std::string& versionName, 
			std::string& buildTime, int& fileSize) override;
